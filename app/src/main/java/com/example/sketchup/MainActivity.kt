...
fun PaintApp() {
    ...
    Column(Modifier.fillMaxSize()) {
        Row(
            ...
            BrushSizeSelector(brushSize, onSizeSelected = {selectedSize -> brushSize = selectedSize}, isErager = isEraser, keepMode = {isEraser = it})
        }
        Row(
...
suspend fun saveDrawingToGallery(context : Context, lines : List<Line>) {
    ...
    if (uri != null) {
        ...
        Toast.makeText(context, "Faild To Save", Toast.LENGTH_SHORT).show()
    }
}
